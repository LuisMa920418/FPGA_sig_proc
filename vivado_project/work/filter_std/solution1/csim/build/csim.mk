...
HLS_SOURCES = ../../../../../design/filter/tb_std.cpp ../../../../../design/filter/filter_std.cpp
...
$(ObjDir)/filter_std.o: ../../../../../design/filter/filter_std.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../design/filter/filter_std.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I/home/elite/Downloads/Signal_proc_FPGA/TP1/vivado_project/vivado_project/vivado_project/design/include  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/filter_std.d
