...
#set lang "verilog"
#set netlistfile "dcnetlist.v.v"
#set sdcfile "dcnetlist.v.sdc"
#set top_name "cascade"
#set leffiles [list ...... ]
#set synlibs [list ......]
#set layers [list CORE a1 srcmetal1 a2 srcmetal2 a3 ...]
set technology "65"
#set aspect "1"
#set util "70"
set max_fanout "32"
...
optimize -mode global -obj {wns hold max_trans}
...
optimize -mode local -obj {wns hold}
place_detail -driven_by timing
route_global
report_variability
report_timing
...
# .. Optimize
optimize -mode post_route -obj {wns max_trans hold} -post_route_driven_by white_space
check_lvs
